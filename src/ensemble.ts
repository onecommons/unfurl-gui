...
const typeMap: any = {
    ...
    "Change": o([
        ...
        { json: "lastConfigChange", js: "lastConfigChange", typ: u(undefined, "") },
        { json: "lastStateChange", js: "lastStateChange", typ: u(undefined, "") },
        { json: "priority", js: "priority", typ: u(undefined, r("Priority")) },
        { json: "readyState", js: "readyState", typ: u(undefined, r("ReadyStateObject")) },
        ...
        { json: "implementation", js: "implementation", typ: u(undefined, r("ImplementationDefinition")) },
        { json: "inputs", js: "inputs", typ: u(undefined, m("any")) },
        { json: "messages", js: "messages", typ: u(undefined, a("any")) },
        { json: "result", js: "result", typ: u(undefined, u(r("ResultEnum"), m("any"))) },
    ...
    "ImplementationDefinition": o([
        ...
        { json: "majorVersion", js: "majorVersion", typ: u(undefined, u(3.14, "")) },
        { json: "minorVersion", js: "minorVersion", typ: u(undefined, "") },
        { json: "operation", js: "operation", typ: u(undefined, "") },
    ], "any"),
    "ReadyStateObject": o([
        { json: "effective", js: "effective", typ: u(undefined, r("EffectiveEnum")) },
    ...
    "Spec": o([
        { json: "service_template", js: "service_template", typ: u(undefined, m("any")) },
        { json: "instances", js: "instances", typ: u(undefined, m("any")) },
    ], "any"),
    "Status": o([
        { json: "inputs", js: "inputs", typ: u(undefined, m("any")) },
        { json: "instances", js: "instances", typ: u(undefined, m(r("Instance"))) },
    ...
    "Instance": o([
        { json: "attributes", js: "attributes", typ: u(undefined, m("any")) },
        { json: "capabilities", js: "capabilities", typ: u(undefined, m(r("Instance"))) },
        { json: "imported", js: "imported", typ: u(undefined, "") },
        { json: "instances", js: "instances", typ: u(undefined, m(r("Instance"))) },
        { json: "requirements", js: "requirements", typ: u(undefined, m(r("Instance"))) },
