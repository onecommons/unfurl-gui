...
const actions = {
    ...
    async fetchDeployment({state, getters, commit, rootGetters, dispatch}, {deploymentName, environmentName, projectPath, branch, setCurrentBranch}) {

        let deployment
        branch = branch || await getOrFetchCurrentBranch(encodeURIComponent(projectPath))
