...
// Our own, not ~/ci/common/private/ci_environments_dropdown: that module
// re-exports .graphql query documents and pulls an Apollo-backed component,
// which the standalone build has neither a loader nor a client for.
