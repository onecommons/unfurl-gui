...
export default {
  ...
  computed: {
    ...
    ...mapComputed([
        { key: 'key', updateFn: 'ci_variables/updateVariableKey' },
        { key: 'secret_value', updateFn: 'ci_variables/updateVariableValue' },
        { key: 'variable_type', updateFn: 'ci_variables/updateVariableType' },
        { key: 'environment_scope', updateFn: 'ci_variables/setEnvironmentScope' },
        { key: 'protected_variable', updateFn: 'ci_variables/updateVariableProtected' },
        { key: 'masked', updateFn: 'ci_variables/updateVariableMasked' },
      ],
      false,
