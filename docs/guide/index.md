...
@formily/gitlab-ui 是基于 GitlabUi 封装的针对表单场景专业级(Professional)组件库，它主要有以下几个特点：
...
`GitlabUi` 按需引入参见 [https://element.eleme.io/#/zh-CN/component/quickstart#an-xu-yin-ru](https://element.eleme.io/#/zh-CN/component/quickstart#an-xu-yin-ru)

`@formily/gitlab-ui`按需引入需借助 `babel-plugin-import`
